 ...
 * A getter method was added for the suit
 * in order to provide classes with the functionality of the whist game.
 * <p>
 * A class to represent a standard card. I
 * t can be ranks 2-Ace with the four suits. Jokers are
 * excluded.
 */
public class StandardCard implements Comparable<StandardCard> {

    /**
     * @param suit The suit as a String (plural form ie. "Hearts",
     *             "Spades", "Diamonds", "Hearts"
     * @param rank The rank as a String 2-10, numbers in
     *             double quotes ie. "2", "3". The remaining
     *             ranks should be spelled out ie. "King",
     *             "Jack", "Queen", "Ace"
     */
    ...
    /**
     * Get this player's suit
     *
     * @return this player's suit
     */
    public Suit getSuit() {
        return this.suit;
    }
